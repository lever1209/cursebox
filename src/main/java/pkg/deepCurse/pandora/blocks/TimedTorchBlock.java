...
// protected static final class_265 BOUNDING_SHAPE = Block.method_9541(6.0D,
// 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
// protected final class_2394 particle;
// protected boolean shouldDieOut;
// protected int age;
//
// public TimedTorchBlock(class_2251 settings, class_2394 particle, Boolean
// shouldDieOut, int totalTickTime) {
// super(settings);
...
// }
//
// public class_265 method_9530(class_2680 state, BlockView world, BlockPos pos,
// class_3726 context) {
// return BOUNDING_SHAPE;
// }
//
// public class_2680 method_9559(class_2680 state, Direction direction,
// class_2680 neighborState, WorldAccess world,
// BlockPos pos, BlockPos neighborPos) {
// return direction == Direction.field_11033 && !this.method_9558(state, world,
// pos)
// ? Blocks.field_10124.method_9564()
// : super.method_9559(state, direction, neighborState, world, pos,
// neighborPos);
// }
//
...
// }
//
// public ActionResult method_9534(class_2680 state, World world, BlockPos pos,
// PlayerEntity player,
// Hand hand, class_3965 hit) {
// return ActionResult.field_5812;
// }
//
// public boolean method_9516(class_2680 state, BlockView world, BlockPos pos,
// NavigationType type) {
// return true;
// }
//
// public void method_9514(class_2680 state, class_3218 world, BlockPos pos,
// Random random) {
// ++this.age;
// if (this.shouldDieOut) {
// if ((random.nextInt(100) > 33 || CurseBox.accelerateTorchDeath) &&
...
// public void method_9496(class_2680 state, World world, BlockPos pos, Random
// random) {
